<div>
    <x-jet-button wire:click="$toggle('creatingNewFolder')">
    ...
    <x-jet-dialog-modal wire:model="creatingNewFolder">
        <x-slot name="title">
            New Folder
        </x-slot>
        ...
        <x-slot name="footer">
            <x-jet-secondary-button wire:click="$toggle('creatingNewFolder')"

<div>
    @if(is_null($this->file()) || $this->file() instanceof \App\Lib\Files\Folder)
        <livewire:files.folder-contents path="{{ $path }}"/>
    ...
    @elseif (($this->file()->isBrowserRenderableImage()))
        <div class="p-8">It's an image at this file path: {{ $this->file()->absolutePath() }}.<br><br>We'll need a way to access it for the img tag.</div>
    @else
